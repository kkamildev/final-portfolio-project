            ...
            <section className="m-2 p-2 flex flex-col">
                ...
                <ul className="text-white">
                    <section className="flex flex-col lg:flex-row gap-x-5 gap-y-5 items-center mb-30">
                        ...
                        <img src={me} alt="Photo of me" className="rounded-2xl h-62.5 w-62.5"/>
                    ...
                    <section className="my-10">
                        <AnimatedBar
                            ...
                            className="bg-red-900 m-0! rounded-l-none!"
                            borders={["20%", "80%"]}
                        />
                        <AnimatedBar
                            animationDuration={Math.random() * 1000 + 1000}
                            className="bg-red-800 m-0! rounded-l-none!"
                            borders={["20%", "80%"]}
                        />
                        <AnimatedBar
                            animationDuration={Math.random() * 1000 + 1000}
                            className="bg-red-700 m-0! rounded-l-none!"
                            borders={["20%", "80%"]}
                        />
                    </section>
                    <section className="flex flex-col lg:flex-row-reverse gap-x-5 gap-y-5 items-center my-30">
                        ...
                        <img src={it} alt="IT technology photo" className="rounded-2xl h-62.5 w-62.5"/>
                    </section>
                    <section className="my-10">
                        <AnimatedBar
                            animationDuration={Math.random() * 1000 + 1000}
                    ...
                    <section className="flex flex-col lg:flex-row-reverse gap-x-5 gap-y-5 items-center my-30">
                        ...
                        <img src={questionMark} alt="question mark" className="rounded-2xl h-62.5 w-62.5"/>
                    </section>
                    <section className="my-10">
                        <AnimatedBar
                            animationDuration={Math.random() * 1000 + 1000}
                    ...
                    <section className="flex flex-col lg:flex-row gap-x-5 gap-y-5 items-center my-30">
                        ...
                        <img src={bullseye} alt="bullseye" className="rounded-2xl h-62.5 w-62.5"/>
                        <section className="flex-1">
