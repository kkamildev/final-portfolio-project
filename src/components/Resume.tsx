...
import { faAddressBook, faBookmark, faEnvelope, faLocationDot } from "@fortawesome/free-solid-svg-icons";
        ...
        <main className="w-full">
            <section className="flex justify-start">
                <section className="flex flex-col ml-3 items-center justify-start">
                    <div className="bg-red-700 h-125 w-[1.65rem]"></div>
                    <FontAwesomeIcon icon={faBookmark} className="text-red-700 text-[35px] relative -top-2.5"/>
                </section>
